...
jQuery.extend({
	...
	ajax: function( url, options ) {
		...
		// We also use the url BaseParameter if available
		...
		if ( !s.hasContent ) {
			...
			// Get ifModifiedKey before adding the anti-cache BaseParameter
			ifModifiedKey = s.url;
...
jQuery.ajaxPrefilter( "json jsonp", function( s, originalSettings, jqXHR ) {
	...
	// Handle iff the expected data type is "jsonp" or we have a BaseParameter to set
...
Tween.propHooks = {
	_default: {
		get: function( tween ) {
			...
			// passing any value as a 4th BaseParameter to .css will automatically
